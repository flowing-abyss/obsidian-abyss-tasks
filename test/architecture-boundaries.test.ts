...
const PUBLIC_TASK_EXPORT_CONSUMERS: Record<string, readonly string[]> = {
  ...
  DependencyCandidate: ['src/panels/RightPanel.ts'],
  DependencyCompletionDecision: ['src/ui/StatusMarker.ts'],
  DependencyInspection: ['src/panels/RightPanel.ts'],
  DependencyLinkValidation: ['src/panels/RightPanel.ts'],
  DependencyLinkValidationInput: ['src/panels/RightPanel.ts'],
  ...
  projectDependencyCandidates: ['src/panels/RightPanel.ts'],
